...
const DevelopmentPage = () => {
  ...
  const areaFaculty = facultyData.filter(faculty => 
    faculty.researchAreas.includes("Retinal Biology")
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          We discover and examine the fundamental biological processes that make vision possible.
          </p>
          <div className="mt-4">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Key Research Areas:</h3>
            <ul className="list-disc pl-6 text-gray-700">
              <li>Retinal pigment epithelium</li>
              <li>photoreceptors and phototransduction</li>
              <li>metabolism</li>
            </ul>
          </div>
        </div>
