...
const DevelopmentPage = () => {
  ...
  const areaFaculty = facultyData.filter(faculty => 
    faculty.researchAreas.includes("Development, Disease, and Aging")
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Hero 
        ...
        subtitle="Understanding Eye Development and Disease"
        description="Research teams working to understand how the eye develops, ages, and becomes diseased"
      />
